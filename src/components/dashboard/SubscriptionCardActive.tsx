...
export default function SubscriptionCardActive({
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 flex items-start justify-between">
        <div>
          ...
          <h2 className="text-lg font-bold tracking-tight text-dark-50">
            {isUnlimited
              ? t('subscription.unlimitedTraffic', 'Безлимитный трафик')
        ...
        <div className="text-right">
          {isUnlimited ? (
            <span
              ...
              style={{
                background: `rgba(${zone.mainVarRaw}, 0.12)`,
                border: `1px solid rgba(${zone.mainVarRaw}, 0.25)`,
                color: zone.mainVar,
              }}
            >
              <span className="text-base leading-none">&#8734;</span>
              {t('subscription.unlimitedTraffic', 'Безлимит')}
            </span>
          ) : (
            <>
      ...
      {/* ─── Progress Bar (only when traffic is limited) ─── */}
      {!isUnlimited && (
        <div className="mb-4">
          <TrafficProgressBar
            usedGb={usedGb}
      ...
      {/* ─── Connect Device Button (aurora-glass, same accent as the referral teaser) ─── */}
      {subscription.subscription_url && (
        <button
          ...
          className={`aurora-hero accent-ring mb-2.5 w-full rounded-[14px] p-3.5 text-left transition-transform duration-300 hover:-translate-y-0.5 active:scale-[0.99] ${
        ...
        >
          <div className="relative z-10 flex items-center gap-3.5">
            {/* Monitor icon */}
            <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-[10px] bg-accent-500/15 text-accent-400">
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-0.5 text-[11px] text-dark-50/50">
            ...
            {subscription.device_limit === 0 ? (
              <div
                className="flex flex-shrink-0 items-center text-lg text-dark-50/50"
                aria-hidden="true"
              >
                ∞
              </div>
      ...
      <div className="mb-4 flex gap-2.5">
        ...
        >
          <div className="mb-1.5 text-[10px] font-semibold uppercase tracking-wider text-dark-50/55">
            {t('dashboard.tariff')}
          </div>
          <div className="min-w-0 truncate text-base font-bold leading-tight tracking-tight text-dark-50">
            {subscription.tariff_name || t('subscription.currentPlan')}
          </div>
          <div className="mt-1 font-mono text-[11px] text-dark-50/55">
        ...
        >
          <div className="mb-1 flex items-center gap-1.5 text-[10px] font-medium uppercase tracking-wider text-dark-50/60">
            <div
          ...
          <div className="flex items-baseline gap-1">
            ...
            <span className="text-xs font-medium text-dark-50/55">
      ...
      {/* ─── Footer row (refresh only when limited) ─── */}
